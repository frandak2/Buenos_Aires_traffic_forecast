# test_talent guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `test_talent/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `test_talent` folder and use the modules inside your notebooks :
...
```python
from test_talent.utils.paths import data_dir
data_dir()
```
